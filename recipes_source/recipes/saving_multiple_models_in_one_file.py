# -*- coding: utf-8 -*-
"""Saving multiple models in one file using PyTorch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DMn1_mTxbZAfmDC31XIIjp9qCRDluuLY

Saving multiple models in one file using PyTorch
=======================
