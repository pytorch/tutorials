# -*- coding: utf-8 -*-
"""Defining a neural network in PyTorch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eHYCpLEj3qHgoUUz9lwnf8X0c-FzQEIR

Defining a neural network in PyTorch
=======================
Deep learning uses artificial neural networks (models), which are computing
systems that are composed of many layers of interconnected units. By passing data through these interconnected units, a neural network is able to learn how to approximate the computations required to transform inputs into outputs. In PyTorch, neural networks can be constructed using the ``torch.nn`` package.
...
In this recipe, we will use ``torch.nn`` to define a neural network intended for the [MNIST dataset](https://pytorch.org/docs/stable/torchvision/datasets.html#mnist).
