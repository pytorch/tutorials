# -*- coding: utf-8 -*-
"""Loading Data in PyTorch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EOcE5HWZM7bn2bm4PfPvLBynOqYenA9D
...
Introduction
---
At the heart of PyTorch data loading utility is the [``torch.utils.data.DataLoader``](https://pytorch.org/docs/stable/data.html#torch.utils.data.DataLoader) class. It represents a Python iterable over a dataset. Libraries in PyTorch offer built-in high-quality datasets for you to use in [``torch.utils.data.Dataset``](https://pytorch.org/docs/stable/data.html#torch.utils.data.Dataset). These datasets are currently available in: 
