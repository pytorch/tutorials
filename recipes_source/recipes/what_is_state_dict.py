# -*- coding: utf-8 -*-
"""What is a state_dict in PyTorch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1C6-q1NaLEB57JeqmXQKA7HAQv10pkqZi
...
Introduction
---
A ``state_dict`` is an integral entity if you are intetested in saving or loading models from PyTorch.
...
In this recipe, we will see how ``state_dict`` is used with a simple model.
