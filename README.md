...
The tutorial build is very large and requires GPUs. If your machine does not have a GPU device, you can preview your HTML build without actually downloading the data and running the tutorial code: 
