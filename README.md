...
> Typically, you would run either in `conda` or `virtualen`. If you want to use `virtualenv`, in the root of the repo, run: `virtualenv venv`, then `source venv/bin/activate`.
