.. note::
    ...
    Click :ref:`here <sphx_glr_download_recipes_defining_a_neural_network.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_recipes_defining_a_neural_network.py:
...
.. _sphx_glr_download_recipes_defining_a_neural_network.py:
