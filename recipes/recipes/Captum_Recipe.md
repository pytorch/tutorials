...
more at [http://captum.ai/tutorials/IMDB_TorchText_Interpret](http://captum.ai/tutorials/IMDB_TorchText_Interpret)
...
consult our website [http://captum.ai](http://captum.ai)

Another useful post by Gilbert Tanner:
[https://gilberttanner.com/blog/interpreting-pytorch-models-with-captum](https://gilberttanner.com/blog/interpreting-pytorch-models-with-captum)

```
# %%%%%%RUNNABLE_CODE_REMOVED%%%%%%
```

[`Download Jupyter notebook: Captum_Recipe.ipynb`](../../_downloads/642248c95070825e7ac912504a919140/Captum_Recipe.ipynb)

[`Download Python source code: Captum_Recipe.py`](../../_downloads/b94668e8c8d352e04672e8eaad180ae6/Captum_Recipe.py)

[`Download zipped: Captum_Recipe.zip`](../../_downloads/d48925c8e8b3b3f9dca08f06f3b65c59/Captum_Recipe.zip)