...
1. generate a (usually random) batch of inputs with maximum sequence length
(either corresponding to max length in the training dataset or to some
predefined threshold)
2. execute a forward and a backward pass with the generated batch, do not
...
- [PyTorch Performance Tuning Documentation](https://pytorch.org/tutorials/recipes/recipes/tuning_guide.html)
- [CUDA Best Practices](https://pytorch.org/docs/stable/notes/cuda.html)
- [Distributed Training Documentation](https://pytorch.org/tutorials/intermediate/ddp_tutorial.html)
...
[`Download Jupyter notebook: tuning_guide.ipynb`](../../_downloads/38991cbc7763ed7e0f1b711da737b391/tuning_guide.ipynb)

[`Download Python source code: tuning_guide.py`](../../_downloads/8c82db84c10318a94cbe213adb618139/tuning_guide.py)

[`Download zipped: tuning_guide.zip`](../../_downloads/810e65eb9306212bd714a1fce48d023b/tuning_guide.zip)