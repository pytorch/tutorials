...
```
loading time without mmap=0.032340288162231445
```
...
```
loading time with mmap=0.002758502960205078
```
...
[`Download Python source code: module_load_state_dict_tips.py`](../../_downloads/edc021e5f7c55efead2a89b91cdfae27/module_load_state_dict_tips.py)

[`Download zipped: module_load_state_dict_tips.zip`](../../_downloads/2326e2b590389f8f54b354778dad5b9a/module_load_state_dict_tips.zip)