...
**Author:** [Lucas Pasqualin](https://github.com/lucasllc), [Iris Zhang](https://github.com/wz337), [Rodrigo Kumpera](https://github.com/kumpera), [Chien-Chin Huang](https://github.com/fegin), [Yunsheng Ni](https://github.com/niyunsheng)
...
from the [Getting Started with Distributed Checkpoint Tutorial](https://github.com/pytorch/tutorials/blob/main/recipes_source/distributed_checkpoint_recipe.rst)
...
In conclusion, we have learned how to use DCP's `async_save()` API to generate checkpoints off the critical training path. We've also learned about the
