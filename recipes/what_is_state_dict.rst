.. note::
    ...
    Click :ref:`here <sphx_glr_download_recipes_what_is_state_dict.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_recipes_what_is_state_dict.py:
...
.. _sphx_glr_download_recipes_what_is_state_dict.py:
