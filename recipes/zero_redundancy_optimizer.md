...
- The high-level idea of [ZeroRedundancyOptimizer](https://pytorch.org/docs/master/distributed.optim.html).
- How to use [ZeroRedundancyOptimizer](https://pytorch.org/docs/master/distributed.optim.html)
...
The idea of [ZeroRedundancyOptimizer](https://pytorch.org/docs/master/distributed.optim.html)
comes from [DeepSpeed/ZeRO project](https://github.com/microsoft/DeepSpeed) and
[Marian](https://github.com/marian-nmt/marian-dev) that shard
...
[Distributed Data Parallel notes](https://pytorch.org/docs/stable/notes/ddp.html).
