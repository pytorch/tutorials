...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="Introduction ------------ PyTorch includes a simple profiler API that is useful when user needs...">

.. only:: html

    .. figure:: /recipes/recipes/images/thumb/sphx_glr_profiler_thumb.png

        :ref:`sphx_glr_recipes_recipes_profiler.py`
