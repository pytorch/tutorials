...
if [[ "${CIRCLE_JOB}" == *worker_* ]]; then
  ...
  python $DIR/remove_runnable_code.py beginner_source/audio_io.py  beginner_source/audio_io.py || true
  python $DIR/remove_runnable_code.py beginner_source/audio_resampling.py  beginner_source/audio_resampling.py || true
  python $DIR/remove_runnable_code.py beginner_source/audio_data_augmentation.py  beginner_source/audio_data_augmentation.py || true
  python $DIR/remove_runnable_code.py beginner_source/audio_feature_extractions.py  beginner_source/audio_feature_extractions.py || true
  python $DIR/remove_runnable_code.py beginner_source/audio_feature_augmentation.py  beginner_source/audio_feature_augmentation.py || true
  python $DIR/remove_runnable_code.py beginner_source/audio_datasets.py  beginner_source/audio_datasets.py || true
