...
with open(noplot_html_file_path, 'r') as noplot_html_file:
  noplot_html = noplot_html_file.read()
with open(hasplot_html_file_path, 'r') as hasplot_html_file:
...
if len(elems) == 0:
  ...
  with open(output_html_file_path, "w") as output_html_file:
