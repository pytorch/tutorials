.. note::
    ...
    Click :ref:`here <sphx_glr_download_beginner_examples_autograd_tf_two_layer_net.py>` to download the full example code
...
.. _sphx_glr_download_beginner_examples_autograd_tf_two_layer_net.py:
