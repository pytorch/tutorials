.. note::
    ...
    Click :ref:`here <sphx_glr_download_advanced_super_resolution_with_caffe2.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_advanced_super_resolution_with_caffe2.py:
...
.. _sphx_glr_download_advanced_super_resolution_with_caffe2.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: super_resolution_with_caffe2.py <super_resolution_with_caffe2.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: super_resolution_with_caffe2.ipynb <super_resolution_with_caffe2.ipynb>`
