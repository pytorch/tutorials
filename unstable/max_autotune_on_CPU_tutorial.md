...
The `max-autotune` mode for the Inductor CPU backend in `torch.compile` ([RFC link](https://github.com/pytorch/pytorch/issues/125683))
...
This feature is in prototype stage. If you have any feature requests or run into any issues, please file a bug report at [GitHub issues](https://github.com/pytorch/pytorch/issues).