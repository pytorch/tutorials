...
- [tabulate](https://pypi.org/project/tabulate/). You can install by running `pip install tabulate`.
...
- An analyzer script is available in the [torch/distributed/flight_recorder](https://github.com/pytorch/pytorch/tree/main/torch/distributed/flight_recorder) directory (details below).
...
This class should inherit from class `::c10d::DebugInfoWriter` [(code)](https://github.com/pytorch/pytorch/blob/release/2.5/torch/csrc/distributed/c10d/NCCLUtils.hpp#L237)
and then register the new writer using `::c10d::DebugInfoWriter::registerWriter` [(code)](https://github.com/pytorch/pytorch/blob/release/2.5/torch/csrc/distributed/c10d/NCCLUtils.hpp#L242)
...
We have convenient scripts available in [pytorch/torch/distributed/flight_recorder](https://github.com/pytorch/pytorch/tree/main/torch/distributed/flight_recorder) directory for analyzing captured
data.
...
convenience script located in the [torch/distributed/flight_recorder](https://github.com/pytorch/pytorch/tree/main/torch/distributed/flight_recorder)
