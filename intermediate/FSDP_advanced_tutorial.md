...
**Author**: [Hamid Shojanazeri](https://github.com/HamidShojanazeri), [Less
Wright](https://github.com/lessw2020), [Rohan Varma](https://github.com/rohan-varma/), [Yanli Zhao](https://github.com/zhaojuanmao)
...
- Read about the [FSDP API](https://pytorch.org/docs/main/fsdp.html).
...
[(link1),](https://pytorch.org/blog/introducing-pytorch-fully-sharded-data-parallel-api/)
[(link2)](https://engineering.fb.com/2021/07/15/open-source/fsdp/))
and a [paper](https://arxiv.org/abs/2304.11277) on
...
read more about PyTorch FSDP [here](https://pytorch.org/blog/introducing-pytorch-fully-sharded-data-parallel-api/).
...
examples](https://github.com/pytorch/examples/tree/main/distributed/FSDP/).
...
Please create a data folder, download the WikiHow dataset from [wikihowAll.csv](https://ucsb.app.box.com/s/ap23l8gafpezf4tq3wapr6u8241zz358) and
...
[summarization_dataset](https://github.com/pytorch/examples/blob/main/distributed/FSDP/summarization_dataset.py).

Next, we add the following code snippets to a Python script "T5_training.py".

Note

The full source code for this tutorial is available in [PyTorch examples](https://github.com/pytorch/examples/tree/main/distributed/FSDP/).
...
are going to use torch elastic, using [torchrun](https://pytorch.org/docs/stable/elastic/run.html) , which will set the
...
As discussed in the [previous tutorial](https://pytorch.org/tutorials/intermediate/FSDP_tutorial.html),
