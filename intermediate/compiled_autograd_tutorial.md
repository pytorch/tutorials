...
- PyTorch 2.4
- Complete the [Introduction to torch.compile](https://pytorch.org/tutorials/intermediate/torch_compile_tutorial.html)
- Read through the TorchDynamo and AOTAutograd sections of [Get Started with PyTorch 2.x](https://pytorch.org/get-started/pytorch-2-x/)
...
- [Backward hooks](https://pytorch.org/docs/stable/notes/autograd.html#backward-hooks-execution) are not captured
...
Compiled Autograd is under active development and is not yet compatible with all existing PyTorch features. For the latest status on a particular feature, refer to [Compiled Autograd Landing Page](https://docs.google.com/document/d/11VucFBEewzqgkABIjebZIzMvrXr3BtcY1aGKpX61pJY).
...
![../_images/entire_verbose_log.png](../_images/entire_verbose_log.png)
...
![../_images/call_hook_node.png](../_images/call_hook_node.png)
...
![../_images/recompile_due_to_node.png](../_images/recompile_due_to_node.png)
...
![../_images/recompile_due_to_dynamic.png](../_images/recompile_due_to_dynamic.png)

## Conclusion

In this tutorial, we went over the high-level ecosystem of `torch.compile` with compiled autograd, the basics of compiled autograd and a few common recompilation reasons. Stay tuned for deep dives on [dev-discuss](https://dev-discuss.pytorch.org/).