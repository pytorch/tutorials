...
[![edit](../_images/pencil-16.png)](../_images/pencil-16.png) View and edit this tutorial in [github](https://github.com/pytorch/tutorials/blob/main/intermediate_source/TCPStore_libuv_backend.rst).
...
Recently, we have rolled out a new TCPStore server backend using [libuv](https://github.com/libuv/libuv), a third-party library for asynchronous I/O. This new server backend aims to
...
[![TCPStore Initialization Runtime Benchmark Result](../_images/tcpstore_init_time.png)](../_images/tcpstore_init_time.png)
...
[![TCPStore Barrier Runtime Benchmark Result](../_images/tcpstore_barrier_time.png)](../_images/tcpstore_barrier_time.png)
