...
You'll need to install the [official rpi-imager](https://www.raspberrypi.com/software/) to install Rasbperry Pi OS.
...
classes and
[use the ImageNet class labels](https://gist.github.com/yrevar/942d3a0ac09ec9e5eb3a)
...
[torchvision.models.quantized](https://pytorch.org/vision/stable/models.html#quantized-models)
...
- [Quantization](https://pytorch.org/docs/stable/quantization.html) for more information on how to quantize and fuse your model.
