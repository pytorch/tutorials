...
- **In the cloud**: This is the easiest way to get started! Each section has a "Run in Microsoft Learn" link at the top, which opens a integrated notebook in Microsoft Learn with the code in a fully-hosted environment. 
