...
# +-----+--------------+------+------+-------------+--------+------------------+---------+------------+
# | ... |   batch_size |   l1 |   l2 |          lr |   iter |   total time (s) |    loss |   accuracy |
# |-----+--------------+------+------+-------------+--------+------------------+---------+------------|
# | ... |            2 |    1 |  256 | 0.000668163 |      1 |          134.033 | 2.31479 |     0.0977 |
# | ... |            4 |   64 |    8 | 0.0331514   |      1 |          128.236 | 2.31605 |     0.0983 |
# | ... |            4 |    2 |    1 | 0.000150295 |      1 |          128.61  | 2.30755 |     0.1023 |
# | ... |           16 |   32 |   32 | 0.0128248   |     10 |         1210.87  | 1.66912 |     0.4391 |
# | ... |            4 |    8 |  128 | 0.00464561  |      2 |          339.263 | 1.7316  |     0.3463 |
# | ... |            8 |  256 |    8 | 0.00031556  |      1 |          123.045 | 2.19409 |     0.1736 |
# | ... |            4 |   16 |  256 | 0.00574329  |      2 |          329.523 | 1.85679 |     0.3368 |
# | ... |            8 |    2 |    2 | 0.00325652  |      1 |          210.424 | 2.30272 |     0.0984 |
# | ... |            2 |    2 |    2 | 0.000342987 |      2 |          341.638 | 1.76044 |     0.292  |
# | ... |            4 |   64 |   32 | 0.003734    |      8 |         1011.5   | 1.53101 |     0.4761 |
# +-----+--------------+------+------+-------------+--------+------------------+---------+------------+
#
