...
# model has *m* inputs and *n* outputs, the weights will be an *m* n\*
# matrix. For example:
# 
...
# 
# The input will be a sentence with the words represented as indices of of
...
# `documentation <https://pytorch.org/docs/stable/nn.html#transformer>`__
