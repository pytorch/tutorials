...
#
# While ATen operators <https://pytorch.org/docs/stable/ir.html> are implemented by
# PyTorch core team, the ONNX exporter team must independently implement their conversion
# to ONNX through `ONNX Script <https://onnxscript.ai/>`_.
#
...
# ---------------------------------
#
# Although the ONNX exporter team has been making their best efforts to support as many ATen
# operators as possible, some ATen operators are still not supported yet. In this section, we
# will demonstrate how you can implement missing ATen operators.
#
