...
# training data.
#
# Note that the code below is tagged to run only in __main__ process, so as to
# skip running in worker child processes. This is needed to have loader workers
# function properly on Windows, in addition to Unix.
#
if __name__=='__main__':
    ...
    # Puse for figure to display, or it won't show up until after the run.
    plt.pause(1)
