...
# ``torch.optim``, ``Dataset``, and ``DataLoader`` to help you create and
# train neural networks. In order to fully utilize their power and customize
...
#
# *NB: We are initializing the weights here with 
...
#
# **NB**: `nn.Module` (uppercase M) is a PyTorch specific concept, and is a 
...
#
# PyTorch's
# `TensorDataset <https://pytorch.org/docs/stable/_modules/torch/utils/data/dataset.html#TensorDataset.`_
...
# to iterate over batches. Rather than having to use `train_ds[i*bs :
...
# a [validation set](http://www.fast.ai/2017/11/13/validation-sets/), in order 
