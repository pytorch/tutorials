# -*- coding: utf-8 -*-
"""neural_networks_tutorial (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YAJHJzHq3VJ9rPATuf8g4UuWeHnyCLxF
"""
...
>
>If you have a single sample, just use ``input.unsqueeze(0)`` to add a fake batch dimension.</p></div>
