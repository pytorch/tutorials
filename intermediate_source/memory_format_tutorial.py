...
######################################################################
# The following list of models has the full support of Channels last and showing 26%-76% perf gains on Intel(R) Xeon(R) Platinum 8380 CPU (codenamed Ice Lake):
