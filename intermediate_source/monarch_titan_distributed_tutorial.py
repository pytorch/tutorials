"""
Distributed Training with Monarch and TorchTitan
==========================================================
...
if __name__ == "__main__":
    ...
    # Execute training on the SLURM cluster
...
# TorchTitan for scalable distributed training on SLURM clusters.
#
# Monarch also integrates with TorchFT to provide per-step fault-tolerance across replicated workers.
# You can find a comprehensive `proof of concept <https://github.com/meta-pytorch/torchft/tree/main/torchft/examples/slurm>`_ for this integration in the TorchFT repo
#
