...
[FBGEMM](https://github.com/pytorch/fbgemm), a collection of CUDA
...
[SPMD](https://en.wikipedia.org/wiki/SPMD) program here but we
can do multiprocessing inside the notebook to mimic the setup. Users
should be responsible for setting up their own
[SPMD](https://en.wikipedia.org/wiki/SPMD) launcher when using
...
[EmbeddingBagCollection](https://github.com/facebookresearch/torchrec/blob/main/torchrec/modules/embedding_modules.py#L59)
...
rank's work during [SPMD](https://en.wikipedia.org/wiki/SPMD)
execution.
...
[SPMD](https://en.wikipedia.org/wiki/SPMD) example in the future
