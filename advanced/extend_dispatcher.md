...
to [register a dispatched operator in C++](dispatcher) and how to write a
...
One example in pytorch repo is [Vulkan TensorImpl](https://github.com/pytorch/pytorch/blob/main/aten/src/ATen/native/vulkan/VulkanOpaqueTensorImpl.h).
...
More details can be found in register kernels for the new backend.
...
[Registering a Dispatched Operator in C++](dispatcher):
...
Here's [an example](https://github.com/pytorch/xla/blob/r1.7/torch_xla/csrc/aten_autograd_ops.h) in the `pytorch/xla` repository.
...
[pytorch/xla repo](https://github.com/pytorch/xla/blob/master/setup.py):
...
See [our C++ extension tutorial](https://pytorch.org/tutorials/advanced/cpp_extension.html#building-with-setuptools)
for more details.

## Custom operator support

Your new backend should work seamlessly with
[customized operators extended in python](https://pytorch.org/docs/stable/notes/extending.html)
...
For [custom operators extended in C++](cpp_autograd) they often come with a
...
As we mentioned in [Registering a Dispatched Operator in C++](dispatcher), kernels registered through m.impl() API
...
PyTorch lets tests run on multiple device types using its [generic device type testing framework](https://github.com/pytorch/pytorch/blob/master/torch/testing/_internal/common_device_type.py).
...
See [this Wiki page](https://github.com/pytorch/pytorch/wiki/Writing-tests-that-run-on-all-available-device-types) for an example of how tests are instantiated.
...
PyTorch is XLA. See [its extension of the generic device type testing framework](https://github.com/pytorch/xla/blob/master/test/pytorch_test_base.py),
...
Backend extenders should join the *#announcement* channel at [pytorch.slack.com](http://pytorch.slack.com/)
...
you can only extend it by modifying [PyTorch Tensor __reduce_ex__ method](https://github.com/pytorch/pytorch/blob/5640b79bf8a5412a0209a919c05c811d5427cc12/torch/tensor.py#L83-L150)
...
Please use [PyTorch dev discussions](https://dev-discuss.pytorch.org/) for questions and discussions. If you have
any feature requests or bug reports, please [file an issue on github](https://github.com/pytorch/pytorch/issues).
