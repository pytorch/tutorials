...
[custom C++ classes](custom_classes.html) tutorial, and
...
> 1. Implement "fake methods" of each of the class's c++ methods, which should
> have the same schema as the C++ implementation.
> 2. Additionally, implement an `__obj_unflatten__` classmethod in the Python
...
[Extending TorchScript with Custom C++ Classes](custom_classes.html),
