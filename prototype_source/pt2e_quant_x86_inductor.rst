...
It supports both static and dynamic quantization. For the different between the two quantization types, please refer to the doc
`here <https://pytorch.org/docs/stable/quantization.html#quantization-mode-support>`_.
